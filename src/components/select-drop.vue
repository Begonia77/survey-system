<template>
  <div class="qs-layout">
    ...
    >
      ...
      >
        <el-input
          style="width: 50%"
          size="small"
          v-model="selectDropForm.options[index]"
        ></el-input>
        &nbsp;&nbsp;
      ...
      <el-form-item>
        <el-button
          size="small"
          type="primary"
          @click="finishForm('selectDropForm')"
          >完成</el-button
        >
        <el-button
          size="small"
          type="danger"
          @click="deleteForm('selectDropForm')"
          >删除</el-button
        >
      </el-form-item>
    </el-form>
    ...
    >
      <div class="sr-left">
        <div class="sr-title">
          <span>{{ qsIndex }}.&nbsp;{{ selectDropForm.title }}</span>
        </div>
...
export default {
  ...
  watch: {
    qsData: {
      handler: function (val, oldVal) {
        this.selectDropForm.qs_id = val.qs_id;
        this.selectDropForm.title = val.qs_title;
        this.selectDropForm.options = val.qs_option;
      },
      deep: true,
    },
  },
  created() {
    ...
    if (this.qsModel === "true") {
      ...
      this.selectDropForm.qs_id = question.qs_id;
      this.selectDropForm.title = question.qs_title;
      this.selectDropForm.options = question.qs_option;
    }
